...
\Bas{Will we use US or UK English?} \Ashley{UK, unless there are
  strong objections. American though I may be, I've always preferred
  UK spelling, and so excepting journals and conferences taking place
  in the US, I always use UK}.
...
Retrieval \acro{(MIR)} community and (automatically extracted) chords are generally
...
like Riffstation\footnote{\url{http://www.riffstation.com/}} and 
Chordify\footnote{\url{http://chordify.net}}~\cite{haas2012} use \acro{ACE} in 
their music teaching tools, and at time of writing Chordify attracts more
