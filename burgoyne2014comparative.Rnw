...
restricted ourselves to discussing the newest and most challenging of
...
high-performing algorithm happened to round off in the other
direction, the performance is extremely and unexpectedly low.
