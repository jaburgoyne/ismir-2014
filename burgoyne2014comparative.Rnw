...
Chordify\footnote{\url{http://chordify.net}}~\cite{haas2012} use ACE in 
...
that ACE algorithms are used outside of academic environments, 
and even though the number of MIREX participants has decreased
...
also performed a rigorous re-evaluation of all MIREX ACE submissions in
2010--2012. As of MIREX
...
been adopted in the context of the MIREX ACE task.
